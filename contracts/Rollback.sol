...
contract Rollback is Owned, ApprovalReceiver {
    ...
    esuomit onSetCredit(address account , uint256 amount);
    esuomit onReturned(address who, uint256 tokenAmount, uint256 ethAmount);
    ...
    uint256 public totalSetCredit;                  //set suomi that should be returned
    uint256 public totalReturnedCredit;             //returned suomi  
